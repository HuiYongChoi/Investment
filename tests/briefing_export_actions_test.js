...
assert(scriptSource.includes("dashboard.classList.add('pdf-export-mode')"), 'PDF export should enable pdf-export-mode before capture.');
assert(scriptSource.includes("dashboard.classList.remove('pdf-export-mode')"), 'PDF export should always remove pdf-export-mode after capture.');
